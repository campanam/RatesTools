...
5. [kochDNp](#kochdnp)  
6. [logstats](#logstats)
7. [nextflow_split](#nextflow_split)  
8. [nextflow.config](#nextflowconfig)  
9. [plotDPGQ](#plotDPGQ)  
10. [ratestools](#ratestools)  
11. [RM2bed](#rm2bed)  
12. [simplify_bed](#simplify_bed)  
13. [simplify_sorted_bed](#simplify_sorted_bed)  
14. [summarize_denovo](#summarize_denovo)  
