...
This README provides basic details for installing, configuring and running the pipeline. Detailed documentation is available for the [Ruby and R scripts](doc/ruby_r_scripts.md) included in this package and for the [pipeline's operation](doc/pipeline_details.md). Test data are provided in the [Smithsonian Institution Figshare repository](###) and a tutorial is available [here](doc/tutorial.md).  
